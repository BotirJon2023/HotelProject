package org.ruzmetov.hotelproject.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * org.ruzmetov.hotelproject.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * org.ruzmetov.hotelproject.service.*.*(..))")
